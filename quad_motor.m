...
m1 = Quad.U1/(4*Quad.KT) + Quad.U2/(4*Quad.KT*Quad.l*sin(pi/4)) + Quad.U3/(4*Quad.KT*Quad.l*sin(pi/4)) + Quad.U4/(4*Quad.Kdx);
m2 = Quad.U1/(4*Quad.KT) + Quad.U2/(4*Quad.KT*Quad.l*sin(pi/4)) - Quad.U3/(4*Quad.KT*Quad.l*sin(pi/4)) - Quad.U4/(4*Quad.Kdx);
m3 = Quad.U1/(4*Quad.KT) - Quad.U2/(4*Quad.KT*Quad.l*sin(pi/4)) - Quad.U3/(4*Quad.KT*Quad.l*sin(pi/4)) + Quad.U4/(4*Quad.Kdx);
m4 = Quad.U1/(4*Quad.KT) - Quad.U2/(4*Quad.KT*Quad.l*sin(pi/4)) + Quad.U3/(4*Quad.KT*Quad.l*sin(pi/4)) - Quad.U4/(4*Quad.Kdx);
