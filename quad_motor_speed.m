...
w1 = Quad.U1/(4*Quad.KT) + Quad.U2/(4*Quad.KT*Quad.l*sin(pi/4)) + Quad.U3/(4*Quad.KT*Quad.l*sin(pi/4)) + Quad.U4/(4*Quad.Kdx);
w2 = Quad.U1/(4*Quad.KT) + Quad.U2/(4*Quad.KT*Quad.l*sin(pi/4)) - Quad.U3/(4*Quad.KT*Quad.l*sin(pi/4)) - Quad.U4/(4*Quad.Kdx);
w3 = Quad.U1/(4*Quad.KT) - Quad.U2/(4*Quad.KT*Quad.l*sin(pi/4)) - Quad.U3/(4*Quad.KT*Quad.l*sin(pi/4)) + Quad.U4/(4*Quad.Kdx);
w4 = Quad.U1/(4*Quad.KT) - Quad.U2/(4*Quad.KT*Quad.l*sin(pi/4)) + Quad.U3/(4*Quad.KT*Quad.l*sin(pi/4)) - Quad.U4/(4*Quad.Kdx);
...
Quad.U2 = Quad.KT*Quad.l*sin(pi/4)*(Quad.O1^2 + Quad.O2^2 - Quad.O3^2 - Quad.O4^2);
Quad.U2_plot(Quad.counter) = Quad.U2;
  
Quad.U3 = Quad.KT*Quad.l*sin(pi/4)*(Quad.O1^2 - Quad.O2^2 - Quad.O3^2 + Quad.O4^2);
Quad.U3_plot(Quad.counter) = Quad.U3;
  
Quad.U4 = Quad.Kd*(Quad.O1^2 - Quad.O2^2 + Quad.O3^2  - Quad.O4^2);
